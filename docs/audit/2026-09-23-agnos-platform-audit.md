...
- Without capture, the kernel fds daimon holds at a spawn are its console (0–2) and its channel ends.
...
- The guest test passes 44 + 20 checks on agnos 1.57.5 under QEMU (57 s).
